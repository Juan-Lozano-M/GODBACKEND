...
from app.controllers.user_controller import get_user_profile, update_user_profile, update_user_interests, update_user_email, update_user_birthdate, update_user_institution
