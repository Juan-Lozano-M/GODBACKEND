...
from app.controllers.testimonial_controller import (
    ...
    # Removimos create_testimonial y delete_testimonial
)
...
# Comentamos las rutas que usan funciones no implementadas
# testimonial_bp.route('/api/testimonials/create', methods=['POST'])(create_testimonial)               # Crear testimonio
# testimonial_bp.route('/api/testimonials/delete', methods=['DELETE'])(delete_testimonial)             # Eliminar testimonio